...
public class JDialog_PindahSPK extends javax.swing.JDialog {
    ...
    public JDialog_PindahSPK(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(JDialog_PindahSPK.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void Load_KodeSPK() {
        try {
            ...
            String Query = "SELECT `tb_spk`.`kode_spk` FROM `tb_spk` LEFT JOIN `tb_pengiriman` ON `tb_spk`.`kode_spk` = `tb_pengiriman`.`kode_spk`"
                    + "WHERE `status` = 'PROSES' AND `tb_pengiriman`.`kode_spk` IS NULL";
    ...
    public void Load_GradeSPK(String kode_SPK) {
        try {
            ...
            while (result.next()) {
                ...
                ComboBox_GradeSPK.addItem(result.getString("no") + "-" + result.getString("grade_waleta") + "-" + result.getString("grade_buyer") + "-" + result.getString("berat_kemasan"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(JDialog_PindahSPK.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void refresh_TabelDaftarBoxPacking() {
        try {
            ...
            model.setRowCount(0);
            sql = "SELECT `tb_box_packing`.`no_box`, `tanggal_masuk`, `tb_grade_bahan_jadi`.`kode_grade`, `tb_box_bahan_jadi`.`keping`, `tb_box_bahan_jadi`.`berat`, `tb_spk_detail`.`kode_spk`, `tb_spk_detail`.`grade_buyer` "
    ...
    private void initComponents() {
        ...
        Table_daftarBoxPacking.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No Box", "Grade", "Tgl Masuk", "Kpg", "Gram", "SPK", "Grade Buyer"
            }
        ) {
        ...
        jLabel3.setText("Daftar Box yang akan di pindah");

        jLabel19.setBackground(new java.awt.Color(255, 255, 255));
        jLabel19.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel19.setText("Pindah SPK");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(button_hapus, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
    ...
    private void button_SAVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_SAVEActionPerformed
        // TODO add your handling code here:
        try {
            String no_grade = no_grade_spk.get(ComboBox_GradeSPK.getSelectedIndex());
            String batch_number = "-", invoice = "";
            sql = "SELECT `no`, `prod_date`, `kode_kh`, `tb_spk_detail`.`kode_spk`, `tb_pengiriman`.`invoice_no` "
                    + "FROM `tb_spk_detail` LEFT JOIN `tb_pengiriman` ON `tb_spk_detail`.`kode_spk` = `tb_pengiriman`.`kode_spk` "
                    + "WHERE `no` = '" + no_grade + "'";
            rs = Utility.db.getStatement().executeQuery(sql);
            if (rs.next()) {
                ...
                if (rs.getString("invoice_no") != null && rs.getString("invoice_no").equals("")) {
                    invoice = "`invoice_pengiriman` = '" + rs.getString("invoice_no") + "', ";
                }
            }
            ...
            Logger.getLogger(JDialog_PindahSPK.class.getName()).log(Level.SEVERE, null, e);
        } finally {
            try {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_PindahSPK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
