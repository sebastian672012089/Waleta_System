...
public class JFrame_TV_SPK_LOKAL extends javax.swing.JFrame {
        ...
        clock = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(JFrame_TV_SPK_LOKAL.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
        clock.start();
...
//                            System.out.println("row = " + row);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_TV_SPK_LOKAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JFrame_TV_SPK_LOKAL chart = new JFrame_TV_SPK_LOKAL();
                chart.pack();
