...
public class JDialog_Setor_LP_F2 extends javax.swing.JDialog {
    ...
    public void getData() {
        try {
            ...
            sql = "SELECT (`cetak_mangkok` + `cetak_pecah` + `cetak_flat`) AS 'awal', `cetak_jidun_real` FROM `tb_cetak` WHERE `no_laporan_produksi` = '" + JPanel_Finishing2.Table_Data_f2.getValueAt(i, 0).toString() + "'";
