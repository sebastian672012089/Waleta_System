 ...
 *
 */
public class ACR122U_Util {

    /**
     * ACR122U_Util instance *
     */
    private static ACR122U_Util instance;

    /**
     * This is the Default Authentication key which was stored in MiFare Classic
     * 1K Cards on Key A. *
     */
    ...
    /**
     * This command is same like above but we have to concat the data(i.e., 6
     * bytes of authentication key ) in the last *
     */
    ...
    /**
     * This command is used to read UID (i.e., Card code from manufacturer
     * block) *
     */
    ...
    /**
     * This command is used write the authentication key on Key B and provide
     * read only access to key B, Key B inherits 0. *
     */
    ...
    /**
     * This command is used to reset trailer block with default key which was
     ...
     * Private Constructor *
     */
    private ACR122U_Util() {
    }

    /**
     * This method will return ACR122U instance *
     */
    public static ACR122U_Util getInstance() {
        if (null == instance) {
            synchronized (ACR122U_Util.class) {
                if (null == instance) {
                    instance = new ACR122U_Util();
                }
            }
        }
        return instance;
     ...
     * @return byte[]
     *
     * <li>This method will return default authentication key for Mifare classic
     * 1K card</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return basic command for user authentication key,
     * Where user have to concatenate the 6 bytes of key in suffix.</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return UID of the Card from manufacturer block
     * (i.e., block 0)</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will the command which is used to read the card
     * block</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return all the trailer blocks of Mifare classic 1K
     * card</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return the command which is used hide authentication
     * key and show as 0 while reading the trailer block</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return command which is used to write data on
     * card.</li>
     */
     ...
     * @return byte[]
     *
     * <li>This method will return command which has default key and default
     * access bits.</li>
     */
