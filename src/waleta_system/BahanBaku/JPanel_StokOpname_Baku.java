...
public class JPanel_StokOpname_Baku extends javax.swing.JPanel {
    ...
    public void refreshTable_DataSO() {
        try {
            ...
            sql = "SELECT `tanggal_stok_opname_baku`, `status` FROM `tb_stokopname_baku` WHERE 1";
            rs = Utility.db.getStatement().executeQuery(sql);
            while (rs.next()) {
                row[0] = rs.getDate("tanggal_stok_opname_baku");
...
//            ColumnsAutoSizer.sizeColumnsToFit(tabel_stockOpname);
    ...
    public void refreshTable_detail_Stok(String tgl_SO) {
        try {
            float total_keping = 0, total_gram = 0;
            DefaultTableModel model = (DefaultTableModel) tabel_data_STOK.getModel();
            model.setRowCount(0);
            String query = "";
            ...
            ColumnsAutoSizer.sizeColumnsToFit(tabel_data_STOK);
            label_total_data_stok.setText(decimalFormat.format(tabel_data_STOK.getRowCount()));
    ...
    public void refreshTable_detail_SCAN(String tgl_SO) {
        try {
            float total_keping = 0, total_gram = 0;
            ...
            String query = "SELECT `tb_stokopname_wip_scan`.`no_laporan_produksi` AS 'lp_scan', `posisi`, `kode_grade`, `ruangan`, `jumlah_keping`, `berat_basah`, LP_WIP.`no_laporan_produksi` "
                    ...
                    + "WHERE `tb_stokopname_wip_scan`.`no_laporan_produksi` LIKE '%" + txt_search_Scan_NoKartu.getText() + "%' "
            ...
            label_total_data_scan.setText(decimalFormat.format(tabel_data_SCAN.getRowCount()));
            label_total_keping_scan.setText(decimalFormat.format(total_keping));
    ...
    private void initComponents() {
        ...
        label_total_data_scan = new javax.swing.JLabel();
        jLabel15 = new javax.swing.JLabel();
        jScrollPane4 = new javax.swing.JScrollPane();
        tabel_data_SCAN = new javax.swing.JTable();
        jLabel2 = new javax.swing.JLabel();
        button_Export_tabelScan = new javax.swing.JButton();
        label_total_keping_scan = new javax.swing.JLabel();
        label_total_gram_scan = new javax.swing.JLabel();
        button_search_Scan = new javax.swing.JButton();
        jLabel10 = new javax.swing.JLabel();
        jLabel16 = new javax.swing.JLabel();
        txt_search_Scan_NoKartu = new javax.swing.JTextField();
        label_tanggal_SO1 = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        button_delete_Scan = new javax.swing.JButton();
        txt_search_Scan_Grade = new javax.swing.JTextField();
        jPanel_LP_WIP = new javax.swing.JPanel();
        label_total_keping_stok = new javax.swing.JLabel();
        label_total_data_stok = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jLabel9 = new javax.swing.JLabel();
        label_tanggal_SO = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        button_refresh_Stok = new javax.swing.JButton();
        label_total_gram_stok = new javax.swing.JLabel();
        button_Export_tabelStok = new javax.swing.JButton();
        jLabel5 = new javax.swing.JLabel();
        txt_search_Stok_NoKartu = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        txt_search_Stok_Grade = new javax.swing.JTextField();
        jScrollPane5 = new javax.swing.JScrollPane();
        tabel_data_STOK = new javax.swing.JTable();

        setBackground(new java.awt.Color(255, 255, 255));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Stock Opname Baku", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
        ...
        label_total_data_scan.setBackground(new java.awt.Color(255, 255, 255));
        label_total_data_scan.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_data_scan.setText("0");

        jLabel15.setBackground(new java.awt.Color(255, 255, 255));
        jLabel15.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel15.setText("Total Gram :");

        tabel_data_SCAN.setAutoCreateRowSorter(true);
        ...
        tabel_data_SCAN.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No Grading", "No Kartu", "Grade", "Stok Kpg", "Stok Gram", "Cek"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tabel_data_SCAN.getTableHeader().setReorderingAllowed(false);
        jScrollPane4.setViewportView(tabel_data_SCAN);

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        jLabel2.setText("No Kartu :");

        button_Export_tabelScan.setBackground(new java.awt.Color(255, 255, 255));
        button_Export_tabelScan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_Export_tabelScan.setText("Export to Excel");
        button_Export_tabelScan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_Export_tabelScanActionPerformed(evt);
            }
        });

        label_total_keping_scan.setBackground(new java.awt.Color(255, 255, 255));
        label_total_keping_scan.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_keping_scan.setText("0");

        label_total_gram_scan.setBackground(new java.awt.Color(255, 255, 255));
        label_total_gram_scan.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_gram_scan.setText("0");

        button_search_Scan.setBackground(new java.awt.Color(255, 255, 255));
        button_search_Scan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_search_Scan.setText("Refresh");
        button_search_Scan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_search_ScanActionPerformed(evt);
            }
        });
        ...
        txt_search_Scan_NoKartu.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_Scan_NoKartu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_Scan_NoKartuKeyPressed(evt);
            }
        });
        ...
        button_delete_Scan.setBackground(new java.awt.Color(255, 255, 255));
        button_delete_Scan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_delete_Scan.setText("Delete");
        button_delete_Scan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_delete_ScanActionPerformed(evt);
            }
        });

        txt_search_Scan_Grade.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_Scan_Grade.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_Scan_GradeKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel_LP_SCANLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_LP_SCANLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_LP_SCANLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_data_scan)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel16)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_keping_scan)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel15)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_gram_scan)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(button_Export_tabelScan))
                    .addGroup(jPanel_LP_SCANLayout.createSequentialGroup()
                        .addComponent(label_tanggal_SO1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_search_Scan_NoKartu, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_search_Scan_Grade, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(button_search_Scan)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(button_delete_Scan)
        ...
        jPanel_LP_SCANLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_LP_SCANLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_LP_SCANLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(button_search_Scan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_search_Scan_NoKartu, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(button_delete_Scan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_search_Scan_Grade, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel_LP_SCANLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(button_Export_tabelScan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel10)
                    .addComponent(label_total_data_scan)
                    .addComponent(jLabel16)
                    .addComponent(label_total_keping_scan)
        ...
        jTabbedPane1.addTab("DATA SUDAH SCAN", jPanel_LP_SCAN);
        ...
        label_total_keping_stok.setBackground(new java.awt.Color(255, 255, 255));
        label_total_keping_stok.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_keping_stok.setText("0");

        label_total_data_stok.setBackground(new java.awt.Color(255, 255, 255));
        label_total_data_stok.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_data_stok.setText("0");
        ...
        button_refresh_Stok.setBackground(new java.awt.Color(255, 255, 255));
        button_refresh_Stok.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_refresh_Stok.setText("Refresh");
        button_refresh_Stok.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_refresh_StokActionPerformed(evt);
            }
        });

        label_total_gram_stok.setBackground(new java.awt.Color(255, 255, 255));
        label_total_gram_stok.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        label_total_gram_stok.setText("0");

        button_Export_tabelStok.setBackground(new java.awt.Color(255, 255, 255));
        button_Export_tabelStok.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_Export_tabelStok.setText("Export to Excel");
        button_Export_tabelStok.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_Export_tabelStokActionPerformed(evt);
            }
        });
        ...
        txt_search_Stok_NoKartu.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_Stok_NoKartu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_Stok_NoKartuKeyPressed(evt);
            }
        });
        ...
        txt_search_Stok_Grade.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_Stok_Grade.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_Stok_GradeKeyPressed(evt);
            }
        });

        tabel_data_STOK.setAutoCreateRowSorter(true);
        tabel_data_STOK.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        tabel_data_STOK.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabel_data_STOK.getTableHeader().setReorderingAllowed(false);
        jScrollPane5.setViewportView(tabel_data_STOK);
            ...
            .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_LP_WIPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_search_Stok_NoKartu, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_search_Stok_Grade, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(button_refresh_Stok)
                        .addGap(0, 407, Short.MAX_VALUE))
                    .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_data_stok)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_keping_stok)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_gram_stok)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(button_Export_tabelStok))
        ...
        jPanel_LP_WIPLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_LP_WIPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(button_refresh_Stok, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_search_Stok_NoKartu, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_search_Stok_Grade, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel_LP_WIPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel8)
                    .addComponent(jLabel9)
                    ...
                    .addComponent(label_total_keping_stok)
                    .addComponent(label_total_gram_stok)
                    .addComponent(button_Export_tabelStok, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(label_total_data_stok))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("DATA STOK BAKU", jPanel_LP_WIP);
    ...
    private void button_refresh_StokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_refresh_StokActionPerformed
        ...
        thread.start();
    }//GEN-LAST:event_button_refresh_StokActionPerformed

    private void button_Export_tabelStokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_Export_tabelStokActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tabel_data_STOK.getModel();
        ExportToExcel.writeToExcel(model, jPanel1);
    }//GEN-LAST:event_button_Export_tabelStokActionPerformed
    ...
    private void button_Export_tabelScanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_Export_tabelScanActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tabel_data_SCAN.getModel();
        ExportToExcel.writeToExcel(model, jPanel1);
    }//GEN-LAST:event_button_Export_tabelScanActionPerformed

    private void txt_search_Scan_NoKartuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_Scan_NoKartuKeyPressed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_txt_search_Scan_NoKartuKeyPressed

    private void button_search_ScanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_search_ScanActionPerformed
        // TODO add your handling code here:
        Thread thread = new Thread() {
            @Override
            public void run() {
        ...
        thread.start();
    }//GEN-LAST:event_button_search_ScanActionPerformed
    ...
    private void button_delete_ScanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_delete_ScanActionPerformed
        // TODO add your handling code here:
        try {
            int j = tabel_data_SCAN.getSelectedRow();
            if (j == -1) {
                ...
                if (dialogResult == JOptionPane.YES_OPTION) {
                    String Query = "DELETE FROM `tb_stokopname_wip_scan` WHERE `tgl_stok_opname_wip` = '" + label_tanggal_SO1.getText() + "' AND `no_laporan_produksi` = '" + tabel_data_SCAN.getValueAt(j, 0).toString() + "'";
                    Utility.db.getConnection().createStatement();
                    if ((Utility.db.getStatement().executeUpdate(Query)) > 0) {
                        JOptionPane.showMessageDialog(this, "data SAVED");
                        refreshTable_DataSO();
    ...
    private void txt_search_Scan_GradeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_Scan_GradeKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_search_Scan_GradeKeyPressed

    private void txt_search_Stok_NoKartuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_Stok_NoKartuKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_search_Stok_NoKartuKeyPressed

    private void txt_search_Stok_GradeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_Stok_GradeKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_search_Stok_GradeKeyPressed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private com.toedter.calendar.JDateChooser Date_stokOpname;
    private javax.swing.JButton button_Export_tabelScan;
    private javax.swing.JButton button_Export_tabelStok;
    private javax.swing.JButton button_delete_Scan;
    ...
    private javax.swing.JButton button_refresh_Stok;
    private javax.swing.JButton button_refresh_dataSO;
    private javax.swing.JButton button_search_Scan;
    ...
    private javax.swing.JLabel label_total_data_scan;
    private javax.swing.JLabel label_total_data_stok;
    private javax.swing.JLabel label_total_gram_scan;
    private javax.swing.JLabel label_total_gram_stok;
    private javax.swing.JLabel label_total_keping_scan;
    private javax.swing.JLabel label_total_keping_stok;
    private javax.swing.JTable tabel_data_SCAN;
    private javax.swing.JTable tabel_data_STOK;
    private javax.swing.JTable tabel_stockOpname;
    private javax.swing.JTextField txt_search_Scan_Grade;
    private javax.swing.JTextField txt_search_Scan_NoKartu;
    private javax.swing.JTextField txt_search_Stok_Grade;
    private javax.swing.JTextField txt_search_Stok_NoKartu;
