...
public class JPanel_Peramalan_gradingBaku extends javax.swing.JPanel {
    ...
    public JPanel_Peramalan_gradingBaku() {
        initComponents();
    }
...
//            PreparedStatement pst = Utility.db.getConnection().prepareStatement(sql);
    ...
    public void LoadData_ramalan() {
        try {
            decimalFormat.setMaximumFractionDigits(2);
            float tot_kpg_grading_baku = 0, tot_gram_grading_baku = 0;
            ...
            DefaultTableModel model_tb_gradingBaku = (DefaultTableModel) tabel_GradingBaku_ramalan.getModel();
            model_tb_gradingBaku.setRowCount(0);
            DefaultTableModel model_tabel_hasil_grading_ramalan = (DefaultTableModel) tabel_hasil_grading_bj_ramalan.getModel();
            ...
            String tgl = "";
            if (Date1_search_tgl_masuk_ramalan.getDate() != null && Date2_search_tgl_masuk_ramalan.getDate() != null) {
                tgl = "AND `tb_bahan_baku_masuk`.`tgl_masuk` BETWEEN '" + dateFormat.format(Date1_search_tgl_masuk_ramalan.getDate()) + "' AND '" + dateFormat.format(Date2_search_tgl_masuk_ramalan.getDate()) + "'";
            }

            sql = "SELECT `tb_grading_bahan_baku`.`no_kartu_waleta`, `tb_bahan_baku_masuk`.`tgl_masuk`, `tb_supplier`.`nama_supplier`, `kode_grade`, `jumlah_keping`, `total_berat`, `harga_bahanbaku`\n"
                    ...
                    + "WHERE "
                    + "`kode_grade` LIKE '%" + txt_search_grade_ramalan.getText() + "%' "
                    + "AND `tb_grading_bahan_baku`.`no_kartu_waleta` LIKE '%" + txt_search_no_kartu_ramalan.getText() + "%' "
                    + "AND `tb_supplier`.`nama_supplier` LIKE '%" + txt_search_supplier_ramalan.getText() + "%' "
                    + tgl;
//            PreparedStatement pst = Utility.db.getConnection().prepareStatement(sql);
            rs = Utility.db.getConnection().prepareStatement(sql).executeQuery();
            HashMap<String, Float[]> RekapGradeBJ = new HashMap<>();
            ...
            while (rs.next()) {
                ...
                row[5] = rs.getInt("total_berat");
                row[6] = Math.round(rs.getDouble("total_berat") * rs.getDouble("harga_bahanbaku"));
                model_tb_gradingBaku.addRow(row);

                tot_kpg_grading_baku = tot_kpg_grading_baku + rs.getInt("jumlah_keping");
                tot_gram_grading_baku = tot_gram_grading_baku + rs.getInt("total_berat");

                String grade_baku = rs.getString("kode_grade");
                float keping_grading_baku = rs.getFloat("jumlah_keping");
                float berat_grading_baku = rs.getFloat("total_berat");
                Object[] ramalan_hasil_grading = new Object[10];
                ramalan_hasil_grading[0] = rs.getString("no_kartu_waleta");
                ...
                for (int i = 0; i < tabel_rekap_bakujadi.getRowCount(); i++) {
                    if (grade_baku.equals(tabel_rekap_bakujadi.getValueAt(i, 0).toString())) {
                        ...
                        float kpg_ramalan = Math.round(persentase * keping_grading_baku / 100f);
                        float gram_ramalan = Math.round(persentase * berat_grading_baku / 100f);
                        ramalan_hasil_grading[0] = rs.getString("no_kartu_waleta");
                        ramalan_hasil_grading[1] = rs.getString("kode_grade");
            ...
            for (String kodeGradeBJ : RekapGradeBJ.keySet()) {
                ...
                rekap_ramalan_BJ[3] = Math.round(rekap_ramalan_gram_BJ / tot_gram_grading_baku * 10000f) / 100f;
            ...
            decimalFormat.setGroupingUsed(true);
            ColumnsAutoSizer.sizeColumnsToFit(tabel_GradingBaku_ramalan);
            label_total_LP_ramalan.setText(Integer.toString(tabel_GradingBaku_ramalan.getRowCount()));
            label_total_kpg_LP_ramalan.setText(decimalFormat.format(tot_kpg_grading_baku));
            label_total_gram_LP_ramalan.setText(decimalFormat.format(tot_gram_grading_baku));

            ColumnsAutoSizer.sizeColumnsToFit(tabel_hasil_grading_bj_ramalan);
            label_total_hasil_grading_ramalan.setText(Integer.toString(tabel_hasil_grading_bj_ramalan.getRowCount()));
    ...
    private void initComponents() {
        ...
        txt_search_supplier_ramalan = new javax.swing.JTextField();
        Date1_search_tgl_masuk_ramalan = new com.toedter.calendar.JDateChooser();
        button_refresh_ramalan = new javax.swing.JButton();
        Date2_search_tgl_masuk_ramalan = new com.toedter.calendar.JDateChooser();
        jLabel13 = new javax.swing.JLabel();
        txt_search_grade_ramalan = new javax.swing.JTextField();
        ...
        tabel_GradingBaku_ramalan = new javax.swing.JTable();
        ...
        tabel_hasil_grading_bj_ramalan = new javax.swing.JTable();
        ...
        jLabel67.setText("Grade:");

        txt_search_supplier_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_supplier_ramalan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_supplier_ramalanKeyPressed(evt);
            }
        });

        Date1_search_tgl_masuk_ramalan.setBackground(new java.awt.Color(255, 255, 255));
        Date1_search_tgl_masuk_ramalan.setDate(new Date(new Date().getTime()- (7 * 24 * 60 * 60 * 1000)));
        Date1_search_tgl_masuk_ramalan.setDateFormatString("dd MMMM yyyy");
        Date1_search_tgl_masuk_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        ...
        Date2_search_tgl_masuk_ramalan.setBackground(new java.awt.Color(255, 255, 255));
        Date2_search_tgl_masuk_ramalan.setDate(new Date());
        Date2_search_tgl_masuk_ramalan.setDateFormatString("dd MMMM yyyy");
        Date2_search_tgl_masuk_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        jLabel13.setText("Tanggal Masuk :");

        txt_search_grade_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        txt_search_grade_ramalan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_search_grade_ramalanKeyPressed(evt);
            }
        });
        ...
        tabel_GradingBaku_ramalan.setAutoCreateRowSorter(true);
        tabel_GradingBaku_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        tabel_GradingBaku_ramalan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "No Kartu", "Tgl Masuk", "Supplier", "Grade", "Kpg", "Berat", "Harga Beli"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Float.class, java.lang.Double.class
            };
            boolean[] canEdit = new boolean [] {
        ...
        tabel_GradingBaku_ramalan.getTableHeader().setReorderingAllowed(false);
        jScrollPane5.setViewportView(tabel_GradingBaku_ramalan);

        jLabel26.setBackground(new java.awt.Color(255, 255, 255));
        jLabel26.setFont(new java.awt.Font("Arial", 1, 11)); // NOI18N
        jLabel26.setText("DATA GRADING BAHAN MENTAH");
        ...
        jLabel27.setText("RAMALAN HASIL GRADING BJ");

        tabel_hasil_grading_bj_ramalan.setAutoCreateRowSorter(true);
        tabel_hasil_grading_bj_ramalan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        tabel_hasil_grading_bj_ramalan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "No Kartu", "Grade Baku", "Grade BJ", "%", "Kpg", "Gram"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tabel_hasil_grading_bj_ramalan.getTableHeader().setReorderingAllowed(false);
        jScrollPane6.setViewportView(tabel_hasil_grading_bj_ramalan);
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_search_grade_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel12)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_search_supplier_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel13)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Date1_search_tgl_masuk_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Date2_search_tgl_masuk_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(txt_search_grade_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel67, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_search_supplier_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Date2_search_tgl_masuk_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Date1_search_tgl_masuk_ramalan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane2.addTab("Ramalan Hasil", jPanel6);
    ...
    private void txt_search_supplier_ramalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_supplier_ramalanKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            refreshTableLP_Ramalan();
        }
    }//GEN-LAST:event_txt_search_supplier_ramalanKeyPressed
    ...
    private void button_export_LP_ramalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_export_LP_ramalanActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tabel_GradingBaku_ramalan.getModel();
        ExportToExcel.writeToExcel(model, this);
    ...
    private void button_ramalan_hasil_gradingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_ramalan_hasil_gradingActionPerformed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) tabel_hasil_grading_bj_ramalan.getModel();
        ExportToExcel.writeToExcel(model, this);
    ...
    private void txt_search_grade_ramalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search_grade_ramalanKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            refreshTableLP_Ramalan();
        }
    }//GEN-LAST:event_txt_search_grade_ramalanKeyPressed
    ...
    private com.toedter.calendar.JDateChooser Date1_search_tgl_masuk_ramalan;
    private com.toedter.calendar.JDateChooser Date2_search_tgl;
    private com.toedter.calendar.JDateChooser Date2_search_tgl_masuk_ramalan;
    ...
    private javax.swing.JTable tabel_GradingBaku_ramalan;
    private javax.swing.JTable tabel_LaporanProduksi;
    private javax.swing.JTable tabel_hasil_grading_bj_ramalan;
    ...
    private javax.swing.JTextField txt_search_grade_ramalan;
    ...
    private javax.swing.JTextField txt_search_supplier_ramalan;
