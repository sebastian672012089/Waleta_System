...
public class JDialog_Show_KTP extends javax.swing.JDialog {
    ...
    public JDialog_Show_KTP(java.awt.Frame parent, boolean modal, String nik, String nama) {
        super(parent, modal);
        initComponents();
...
//                System.out.println("code:" + conn.getResponseCode());
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(button_rotate_left, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbl_Image, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void button_rotate_leftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_rotate_leftActionPerformed
        ...
        File input = new File("\\\\192.168.10.2\\Shared Folder\\DOKUMEN SISTEM\\FC_KTP\\" + id + ".JPG");
        File output = new File("\\\\192.168.10.2\\Shared Folder\\DOKUMEN SISTEM\\FC_KTP\\" + id + ".JPG");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new JDialog_Show_KTP(null, true, "test", "test").setVisible(true);
            }
        });
