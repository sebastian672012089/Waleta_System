...
public class JDialog_reProcess extends javax.swing.JDialog {
    ...
    public JDialog_reProcess(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
...
//                    + "AND `berat` > 0";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Re-Proses Bahan Jadi");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ComboBox_tujuan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ComboBox_tujuan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void button_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_saveActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < table_reproses.getRowCount(); i++) {
                String update = "UPDATE `tb_box_bahan_jadi` SET `status_terakhir`='Re-Processing',`lokasi_terakhir`='RE-PROSES',`tgl_proses_terakhir`='" + dateFormat.format(date) + "' "
                        + "WHERE `no_box` = '" + table_reproses.getValueAt(i, 0) + "'";
                Utility.db.getConnection().createStatement();
                Utility.db.getStatement().executeUpdate(update);

                String reproses = "INSERT INTO `tb_reproses`(`no_box`, `tanggal_proses`, `keping`, `gram`, `bagian`) "
                        + "VALUES ('" + table_reproses.getValueAt(i, 0) + "','" + dateFormat.format(date) + "','" + table_reproses.getValueAt(i, 2) + "','" + table_reproses.getValueAt(i, 3) + "','" + ComboBox_tujuan.getSelectedItem() + "')";
                Utility.db.getConnection().createStatement();
                Utility.db.getStatement().executeUpdate(reproses);
            }
            Utility.db.getConnection().commit();
            JOptionPane.showMessageDialog(this, "Data re-proses ke bagian " + ComboBox_tujuan.getSelectedItem() + " telah berhasil ditambahkan");
...
//        ColumnsAutoSizer.sizeColumnsToFit(table_reproses);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_reProcess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.JComboBox<String> ComboBox_tujuan;
