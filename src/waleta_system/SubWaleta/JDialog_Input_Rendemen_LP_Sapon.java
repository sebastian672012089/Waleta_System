...
public class JDialog_Input_Rendemen_LP_Sapon extends javax.swing.JDialog {
    ...
    public JDialog_Input_Rendemen_LP_Sapon(java.awt.Frame parent, boolean modal, String no_lp) {
        super(parent, modal);
    ...
    public void getdata() {
        try {
            ...
            if (rst.next()) {
                ...
                label_gram_sapon.setText(rst.getString("gram_sapon"));
                ...
                float gram_sh = rst.getFloat("gram_sapon") - (rst.getFloat("rendemen_bersih") + rst.getFloat("hancuran") + rst.getFloat("rontokan_kotor") + rst.getFloat("rontokan_kuning"));
                float persen_sh = gram_sh / rst.getFloat("gram_sapon") * 100f;
    ...
    public void hitung_sh() {
        try {
            float gram_sapon = Float.valueOf(label_gram_sapon.getText());
            ...
            float gram_sh = gram_sapon - (rendemen_bersih + hancuran + rontokan_kotor + rontokan_kuning);
    ...
    private void initComponents() {
        ...
        label_gram_sapon = new javax.swing.JLabel();
        ...
        jLabel1.setText("Input Rendemen LP Sapon");
        ...
        label_gram_sapon.setBackground(new java.awt.Color(255, 255, 255));
        label_gram_sapon.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        label_gram_sapon.setText("0");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_rontokan_kotor, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(label_susut_hilang, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(label_gram_sapon, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(txt_rendemen_bersih, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(txt_rontokan_kuning, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                            .addComponent(txt_hancuran, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(label_gram_sapon, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void button_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_saveActionPerformed
        ...
        try {
            ...
            if (check) {
                ...
                String Query = "UPDATE `tb_laporan_produksi_sapon` SET "
    ...
    private javax.swing.JLabel label_gram_sapon;
