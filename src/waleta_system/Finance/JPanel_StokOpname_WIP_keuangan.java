...
public class JPanel_StokOpname_WIP_keuangan extends javax.swing.JPanel {
    ...
    public JPanel_StokOpname_WIP_keuangan() {
        initComponents();
    }
    ...
    public void refreshTable_DataSO() {
        try {
            ...
            sql = "SELECT `tgl_stok_opname_wip`, `status`"
                    ...
                    + "WHERE 1 ORDER BY `tgl_stok_opname_wip` DESC";
...
//            ColumnsAutoSizer.sizeColumnsToFit(tabel_stockOpname);
    ...
    public void refreshTable_detailLP_WIP(String tgl_SO) {
        try {
            ...
            model.setRowCount(0);
            String query = "SELECT `tb_laporan_produksi`.`no_laporan_produksi`, `tb_laporan_produksi`.`kode_grade`, `tb_laporan_produksi`.`ruangan`, `tb_laporan_produksi`.`jumlah_keping`, `tb_laporan_produksi`.`berat_basah`, `harga_bahanbaku`, "
            ...
            while (result.next()) {
                ...
                row[2] = result.getString("ruangan");
                row[3] = result.getString("kode_grade");
...
//                }
                ...
                row[6] = posisi;
                row[7] = result.getString("lp_scan");
                row[8] = result.getDouble("harga_bahanbaku");
                row[9] = result.getDouble("harga_bahanbaku") * result.getDouble("berat_basah");
                if (ComboBox_posisi_lp_wip.getSelectedItem().equals("All")) {
                    ...
                    total_nilai = total_nilai + (result.getDouble("harga_bahanbaku") * result.getDouble("berat_basah"));
                } else {
            ...
            label_total_lp_wip.setText(decimalFormat.format(tabel_data_LP_WIP.getRowCount()));
    ...
    private void initComponents() {
        ...
        label_total_nilai_lp_wip = new javax.swing.JLabel();
        ...
        label_total_lp_scan.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        label_total_keping_lp_scan.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        label_total_keping_lp_scan.setText("0");

        label_total_gram_lp_scan.setBackground(new java.awt.Color(255, 255, 255));
        label_total_gram_lp_scan.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        label_total_keping_lp_wip.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        label_total_lp_wip.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        tabel_data_LP_WIP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal LP", "No LP", "Ruang", "Grade", "Kpg", "Gram", "Posisi", "Scan", "Harga Satuan", "Total"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.Float.class
            };
            boolean[] canEdit = new boolean [] {
        ...
        label_total_gram_lp_wip.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        ...
        label_total_nilai_lp_wip.setBackground(new java.awt.Color(255, 255, 255));
        label_total_nilai_lp_wip.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        label_total_nilai_lp_wip.setText("0");
            ...
            .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_LP_WIPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_LP_WIPLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(label_total_nilai_lp_wip)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private javax.swing.JLabel label_total_nilai_lp_wip;
