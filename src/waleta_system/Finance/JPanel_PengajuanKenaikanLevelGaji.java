...
public class JPanel_PengajuanKenaikanLevelGaji extends javax.swing.JPanel {
    ...
    public JPanel_PengajuanKenaikanLevelGaji() {
        initComponents();
        Table_pengajuan_kenaikan_gaji.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                if (!event.getValueIsAdjusting() && Table_pengajuan_kenaikan_gaji.getSelectedRow() != -1) {
                    ...
                    if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 8) != null
                            || Table_pengajuan_kenaikan_gaji.getValueAt(i, 9) != null
                            || Table_pengajuan_kenaikan_gaji.getValueAt(i, 10) != null
                            || Table_pengajuan_kenaikan_gaji.getValueAt(i, 11) != null) {
                    ...
                    button_diketahui_manager.setEnabled(true);
                    button_disetujui_direktur.setEnabled(true);
                    button_diketahui_keuangan.setEnabled(true);
                    button_dibatalkan.setEnabled(true);
                    if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 8) == null) {
                        //belum diketahui kadep
                        button_diketahui_manager.setEnabled(false);
                        button_disetujui_direktur.setEnabled(false);
                        button_diketahui_keuangan.setEnabled(false);
                    } else {
                        //sudah diketahui kadep
                        if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 9) == null) {
                            //belum diketahui manager
                            button_diketahui_manager.setEnabled(true);
                            button_disetujui_direktur.setEnabled(false);
                            button_diketahui_keuangan.setEnabled(false);
                        } else {
                            //sudah diketahui manager
                            button_diketahui_manager.setEnabled(false);
                            if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 10) == null) {
                                ...
                                if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 11) == null) {
                                    //belum di ketahui keuangan
                                    button_diketahui_keuangan.setEnabled(true);
                                    button_delete.setEnabled(true);
                                } else {
                                    //sudah diketahui keuangan
                                    button_diketahui_keuangan.setEnabled(false);
                                    button_delete.setEnabled(false);
                                }
                            }
                    ...
                    if (Table_pengajuan_kenaikan_gaji.getValueAt(i, 12) != null) {
                        //sudah dibatalkan
                        button_diketahui_manager.setEnabled(false);
                        button_disetujui_direktur.setEnabled(false);
                        button_diketahui_keuangan.setEnabled(false);
                        button_dibatalkan.setEnabled(false);
                    }
                }
            }
        });
    ...
    public void refreshTable() {
        try {
            ...
            while (rs.next()) {
                row[0] = rs.getInt("no");
                row[1] = rs.getString("admin");
                row[2] = rs.getDate("tanggal_pengajuan");
                row[3] = rs.getString("id_pegawai");
                row[4] = rs.getString("nama_pegawai");
                row[5] = rs.getString("nama_bagian");
                row[6] = rs.getString("level_gaji_lama");
                row[7] = rs.getString("level_gaji_baru");
                row[8] = rs.getString("diketahui_kadep");
                row[9] = rs.getString("diketahui_manager");
                row[10] = rs.getString("disetujui_direktur");
                row[11] = rs.getString("diketahui_keuangan");
                row[12] = rs.getString("dibatalkan");
                row[13] = rs.getString("catatan");
    ...
    private void initComponents() {
        ...
        button_disetujui_direktur = new javax.swing.JButton();
        button_diketahui_keuangan = new javax.swing.JButton();
        button_diketahui_manager = new javax.swing.JButton();
        jLabel15 = new javax.swing.JLabel();
        ComboBox_diketahui_kadep = new javax.swing.JComboBox<>();
        button_dibatalkan = new javax.swing.JButton();
        ...
        button_disetujui_direktur.setBackground(new java.awt.Color(255, 255, 255));
        button_disetujui_direktur.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_disetujui_direktur.setText("Disetujui Direktur");
        button_disetujui_direktur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_disetujui_direkturActionPerformed(evt);
            }
        });

        button_diketahui_keuangan.setBackground(new java.awt.Color(255, 255, 255));
        button_diketahui_keuangan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_diketahui_keuangan.setText("Diketahui Keuangan");
        button_diketahui_keuangan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_diketahui_keuanganActionPerformed(evt);
            }
        });

        button_diketahui_manager.setBackground(new java.awt.Color(255, 255, 255));
        button_diketahui_manager.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_diketahui_manager.setText("Diketahui Manager");
        button_diketahui_manager.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_diketahui_managerActionPerformed(evt);
            }
        });
        ...
        button_dibatalkan.setBackground(new java.awt.Color(255, 0, 0));
        button_dibatalkan.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        button_dibatalkan.setForeground(new java.awt.Color(255, 0, 0));
        button_dibatalkan.setText("Dibatalkan");
        button_dibatalkan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_dibatalkanActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel_Customer_bakuLayout.createSequentialGroup()
                        .addGroup(jPanel_Customer_bakuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel_Customer_bakuLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(button_diketahui_manager)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(button_disetujui_direktur)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(button_diketahui_keuangan)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(button_dibatalkan)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel_Customer_bakuLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_Customer_bakuLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_Customer_bakuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(button_diketahui_manager, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_insert, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_diketahui_keuangan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_edit, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_disetujui_direktur, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(label_total_data, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_dibatalkan, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void button_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_editActionPerformed
        ...
        if (i > -1) {
            ...
            String tgl_pengajuan = Table_pengajuan_kenaikan_gaji.getValueAt(i, 2).toString();
            String id_pegawai = Table_pengajuan_kenaikan_gaji.getValueAt(i, 3).toString();
            String level_baru = Table_pengajuan_kenaikan_gaji.getValueAt(i, 7).toString();
            String catatan = Table_pengajuan_kenaikan_gaji.getValueAt(i, 13).toString();
    ...
    private void button_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_deleteActionPerformed
        // TODO add your handling code here:
        try {
            int j = Table_pengajuan_kenaikan_gaji.getSelectedRow();
            if (j == -1) {
                JOptionPane.showMessageDialog(this, "Silahkan pilih data pada tabel");
            } else {
                ...
                if (dialogResult == JOptionPane.YES_OPTION) {
                    // delete code here
                    String Query = "DELETE FROM `tb_level_gaji_pengajuan_kenaikan` WHERE `no` = '" + Table_pengajuan_kenaikan_gaji.getValueAt(j, 0).toString() + "'";
    ...
    private void button_disetujui_direkturActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_disetujui_direkturActionPerformed
        // TODO add your handling code here:
        try {
            int i = Table_pengajuan_kenaikan_gaji.getSelectedRow();
            if (i >= 0) {
                boolean check = true;
                String nama_bagian = "";
                sql = "SELECT `nama_bagian` FROM `tb_bagian` WHERE `kode_bagian` = '" + MainForm.Login_kodeBagian + "'";
                rs = Utility.db.getStatement().executeQuery(sql);
                if (rs.next()) {
                    nama_bagian = rs.getString("nama_bagian");
                }

                if (!nama_bagian.toUpperCase().contains("DIREKTUR") && !MainForm.Login_idPegawai.equals("20180102221")) {
                    JOptionPane.showMessageDialog(this, "Harap login menggunakan user DIREKTUR !");
                    check = false;
                }

                if (check) {
                    String nomor = Table_pengajuan_kenaikan_gaji.getValueAt(Table_pengajuan_kenaikan_gaji.getSelectedRow(), 0).toString();
                    sql = "UPDATE `tb_level_gaji_pengajuan_kenaikan` SET "
                            + "`disetujui_direktur`='" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "' "
                            + "WHERE `no` = '" + nomor + "'";
    ...
    private void button_diketahui_keuanganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_diketahui_keuanganActionPerformed
        // TODO add your handling code here:
        try {
            ...
            if (i >= 0) {
                ...
                if (check) {
                    String nomor = Table_pengajuan_kenaikan_gaji.getValueAt(i, 0).toString();
                    sql = "UPDATE `tb_level_gaji_pengajuan_kenaikan` SET "
                            + "`diketahui_keuangan`='" + MainForm.Login_NamaPegawai + " " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "' "
                            + "WHERE `no` = '" + nomor + "'";
                    Utility.db.getStatement().executeUpdate(sql);

                    String id_pegawai = Table_pengajuan_kenaikan_gaji.getValueAt(i, 3).toString();
                    String nama_pegawai = Table_pengajuan_kenaikan_gaji.getValueAt(i, 4).toString();
                    String level_baru = Table_pengajuan_kenaikan_gaji.getValueAt(i, 7).toString();
                    sql = "UPDATE `tb_karyawan` SET "
                            + "`level_gaji`='" + level_baru + "' "
                            + "WHERE `id_pegawai` = '" + id_pegawai + "'";
                    Utility.db.getStatement().executeUpdate(sql);

                    Utility.db.getConnection().commit();
                    JOptionPane.showMessageDialog(this, "Data Saved!\nLevel gaji " + nama_pegawai + " telah berubah");
                    refreshTable();
                }
            } else {
                JOptionPane.showMessageDialog(this, "Anda belum memilih data!");
    ...
    }//GEN-LAST:event_button_diketahui_keuanganActionPerformed

    private void button_diketahui_managerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_diketahui_managerActionPerformed
        // TODO add your handling code here:
        try {
            int i = Table_pengajuan_kenaikan_gaji.getSelectedRow();
            if (i >= 0) {
                ...
                if (!nama_bagian.toUpperCase().contains("MANAGER") && !MainForm.Login_idPegawai.equals("20180102221")) {
                    JOptionPane.showMessageDialog(this, "Harap login menggunakan user MANAGER !");
                    check = false;
                }
                ...
                if (check) {
                    String nomor = Table_pengajuan_kenaikan_gaji.getValueAt(Table_pengajuan_kenaikan_gaji.getSelectedRow(), 0).toString();
                    sql = "UPDATE `tb_level_gaji_pengajuan_kenaikan` SET "
                            + "`diketahui_manager`='" + MainForm.Login_NamaPegawai + " " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "' "
                            + "WHERE `no` = '" + nomor + "'";
                    Utility.db.getStatement().executeUpdate(sql);
                    JOptionPane.showMessageDialog(this, "Data Saved!");
                    refreshTable();
    ...
    private void button_dibatalkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_dibatalkanActionPerformed
        // TODO add your handling code here:
        try {
            int i = Table_pengajuan_kenaikan_gaji.getSelectedRow();
            if (i >= 0) {
                ...
                if (!nama_bagian.toUpperCase().contains("MANAGER") && !nama_bagian.toUpperCase().contains("DIREKTUR") && !MainForm.Login_idPegawai.equals("20180102221")) {
                    JOptionPane.showMessageDialog(this, "Harap login menggunakan user MANAGER / DIREKTUR !");
                    check = false;
                }
                ...
                if (check) {
                    String nomor = Table_pengajuan_kenaikan_gaji.getValueAt(Table_pengajuan_kenaikan_gaji.getSelectedRow(), 0).toString();
                    sql = "UPDATE `tb_level_gaji_pengajuan_kenaikan` SET "
                            + "`dibatalkan`='" + MainForm.Login_NamaPegawai + " " + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "' "
                            + "WHERE `no` = '" + nomor + "'";
                    Utility.db.getStatement().executeUpdate(sql);
                    JOptionPane.showMessageDialog(this, "Data Saved!");
                    refreshTable();
    ...
    public javax.swing.JButton button_dibatalkan;
    public javax.swing.JButton button_diketahui_keuangan;
    public javax.swing.JButton button_diketahui_manager;
    public javax.swing.JButton button_disetujui_direktur;
