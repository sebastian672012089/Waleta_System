...
public class JDialog_JadwalKerjaSecurity_Tambah extends javax.swing.JDialog {
    ...
    public JDialog_JadwalKerjaSecurity_Tambah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Date_jadwal = new com.toedter.calendar.JDateChooser();
        ...
        button_pilih_pegawai.setText("Pilih Karyawan");
        ...
        Date_jadwal.setBackground(new java.awt.Color(255, 255, 255));
        Date_jadwal.setDateFormatString("dd MMM yyyy");
        Date_jadwal.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(Date_jadwal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(button_pilih_pegawai, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Date_jadwal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void button_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_saveActionPerformed
        try {
            sql = "INSERT INTO `tb_jadwal_kerja_sc`(`id_pegawai`, `jenis_hari`, `tanggal`, `jadwal_masuk`, `jadwal_pulang`, `durasi_istirahat`) "
                    + "VALUES ("
                    + "'" + label_id.getText() + "',"
                    + "'" + ComboBox_jenisHari.getSelectedItem() + "',"
                    + "'" + dateFormat.format(Date_jadwal.getDate()) + "',"
                    + "'" + String.format("%02d", Spinner_jam_masuk.getValue()) + ":" + String.format("%02d", Spinner_menit_masuk.getValue()) + ":00',"
                    + "'" + String.format("%02d", Spinner_jam_pulang.getValue()) + ":" + String.format("%02d", Spinner_menit_pulang.getValue()) + ":00',"
                    + "'" + txt_istirahat.getText() + "'"
                    + ")";
    ...
    private void button_pilih_pegawaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_pilih_pegawaiActionPerformed
        ...
        if (x != -1) {
            ...
            try {
                sql = "SELECT `id_pegawai` FROM `tb_karyawan` WHERE `id_pegawai` = '" + label_id.getText() + "' AND `jam_kerja` = 'SHIFT_MALAM'";
    ...
    private com.toedter.calendar.JDateChooser Date_jadwal;
