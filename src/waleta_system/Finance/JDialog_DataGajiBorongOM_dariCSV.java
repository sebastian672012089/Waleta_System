...
public class JDialog_DataGajiBorongOM_dariCSV extends javax.swing.JDialog {
    ...
    public JDialog_DataGajiBorongOM_dariCSV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void refreshTable() {
        ...
        try {
            ...
            sql = "SELECT `tanggal`, `tb_gaji_borong_om`.`id_pegawai`, `tb_karyawan`.`nama_pegawai`, `gaji_borong` \n"
                    + "FROM `tb_gaji_borong_om` "
                    + "LEFT JOIN `tb_karyawan` ON `tb_gaji_borong_om`.`id_pegawai` = `tb_karyawan`.`id_pegawai`\n"
                    + "WHERE `tb_gaji_borong_om`.`id_pegawai` LIKE '%" + txt_id_pegawai.getText() + "%' "
                    + "AND `tb_karyawan`.`nama_pegawai` LIKE '%" + txt_nama.getText() + "%'"
                    + filter_tanggal;
            rs = Utility.db.getStatement().executeQuery(sql);
            Object[] row = new Object[5];
            double total_gaji_borong = 0;
            while (rs.next()) {
                row[0] = rs.getDate("tanggal");
                row[1] = rs.getString("id_pegawai");
                row[2] = rs.getString("nama_pegawai");
                row[3] = rs.getFloat("gaji_borong");
                total_gaji_borong = total_gaji_borong + rs.getFloat("gaji_borong");
                model.addRow(row);
            }
            ...
            label_total_gaji_borong_OM.setText(decimalFormat.format(total_gaji_borong));
        } catch (SQLException ex) {
            Logger.getLogger(JDialog_DataGajiBorongOM_dariCSV.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        label_total_gaji_borong_OM = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        button_delete = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("DATA GAJI BORONG OM");
        ...
        label_total_gaji_borong_OM.setBackground(new java.awt.Color(255, 255, 255));
        label_total_gaji_borong_OM.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        label_total_gaji_borong_OM.setText("0");

        jLabel7.setBackground(new java.awt.Color(255, 255, 255));
        jLabel7.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel7.setText("Total Gaji Borong OM :");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(label_total_gaji_borong_OM)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(label_total_gaji_borong_OM, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(button_delete))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void button_input_gaji_borong_OMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_input_gaji_borong_OMActionPerformed
        ...
        try {
            JOptionPane.showMessageDialog(this, "Harap hanya memasukkan gaji borong karyawan OM\n"
                    + "Format csv (ID Pegawai,Tanggal(yyyy-mm-dd),Gaji Borong)\n"
                    + "pemisah koma (,)");
            int n = 0;
                    ...
                    try {
                        ...
                        while ((line = br.readLine()) != null) {
                            ...
                            String Query = "INSERT INTO `tb_lembur_rekap`(`id_pegawai`, `tanggal`, `gaji_borong`) "
                                    ...
                                    + "ON DUPLICATE KEY UPDATE `gaji_borong`=" + value[2];
                            Utility.db.getConnection().prepareStatement(Query);
                            Utility.db.getStatement().executeUpdate(Query);
                            String INSERT_tb_gaji_borong_om = "INSERT INTO `tb_gaji_borong_om`(`id_pegawai`, `tanggal`, `gaji_borong`) "
                                    + "VALUES ('" + value[0] + "','" + value[1] + "'," + value[2] + ") "
                                    + "ON DUPLICATE KEY UPDATE `gaji_borong`=" + value[2];
                            Utility.db.getConnection().prepareStatement(INSERT_tb_gaji_borong_om);
                            Utility.db.getStatement().executeUpdate(INSERT_tb_gaji_borong_om);
        ...
        if (j == -1) {
            ...
            try {
                ...
                if (dialogResult == JOptionPane.YES_OPTION) {
                    String DELETE = "DELETE FROM `tb_gaji_borong_om` WHERE `tanggal` = '" + tabel_bonus_pencapaian_produksi.getValueAt(j, 0).toString() + "' "
                    ...
                    String UPDATE = "UPDATE `tb_lembur_rekap` SET `gaji_borong` = 0 "
                            + "WHERE `tanggal` = '" + tabel_bonus_pencapaian_produksi.getValueAt(j, 0).toString() + "' "
                            + "AND `id_pegawai` = '" + tabel_bonus_pencapaian_produksi.getValueAt(j, 1).toString() + "'";
                    Utility.db.getConnection().createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_DataGajiBorongOM_dariCSV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel label_total_gaji_borong_OM;
